...
import TermConditions from "./assets/terms&conditions.pdf";
      ...
      <Container className="text__container">
        <Row>
          <Col>
            ...
            <h3> SENOCARE CARE MANAGER (CM) & ASSISTANT CARE MANAGER (ACM)</h3>
            <ul>
              <li>
            ...
            <ul>
              <li>
                Senocare is a service provider and conducts strict due diligence
                before empaneling professionals & other service providers.
                However, Senocare shall in no manner be responsible for the
                services provided by such professionals and/ or services
                providers as may be selected by the member.
              </li>
              <li>
                Senocare shall provide members with access to qualified doctors,
                accredited labs, trained nurses. Members are free to select
                these services/ medical personnel and choose to use these
                services as per their own discretion. Senocare shall not be
                responsible for any liabilities arising from the use of these
              ...
              <li>
                ...
                pulse, oxygen & give CPR (Cardiopulmonary resuscitation or First
                Aid).
              </li>
              <li>
                Complimentary consultation offered with doctors / dieticians are
                strictly restricted to those doctors empaneled with Senocare.
                However, member can ask the Care Manager to book an online
                consultation with other specialists as per actual costs.
              </li>
              <li>
                Medical emergency service is restricted to assistance in getting
                access to ambulance and coordination with hospital on the phone.
              </li>
              <li>
              ...
              <li>
                ...
                free to choose the professional or refer to their own doctor or
                service provider.
              </li>
            </ul>
            ...
            <ul>
              <li>
                The staff is expected to stay 24/7 with the member. However, the
                working hours are limited to 8 hours per
              </li>
              <li>
            ...
            <ul>
              <li>
                The staff is expected to provide dedicated service upto 12 hours
                with the member
              </li>
              <li>
            ...
            <ul>
              ...
              <li>
                ...
                that there is no verbal, mental or physical harassment or abuse
                of the attendant / nursing staff at their residence
              </li>
              <li>
              ...
              <li>
                Provide the attendant/nurse with the required equipment to carry
                out his/her job, including “Personal Protective Equipment” like
                disposable gloves, masks, apron, etc. to take care of the member
              </li>
              <li>
              ...
              <li>
                ...
                wishes. Doing so construes illegal detention and the member will
                be responsible for any contingencies arising from the behavior
                of the member or any harm done to the attendant/nurse
              </li>
              <li>
        ...
        <Row>
          <Col>
            ...
            <p>
              ...
              obtaining care or facilitate health related surgery or operations.
              Members agree and acknowledge that such information (along with
              other personal information of the members as may be required) may
              be shared by Senocare with other service providers in order to
              ensure that the requested services may be provided to the member.
              Members thus consent to such transmission/ sharing of information
              to the extent necessary for provision of the requested services.
            </p>
            <h3>
            ...
            <p>
              ...
              disclosed to member’s family members, medical equipment suppliers
              or other health care professionals with the sole intentions of
              providing the best health care to Senocare members.
            </p>
            ...
            <p>
              ...
              improvise internal company operations: Senocare will/may disclose
              the member’s health information to better and improvise quality
              care provided to its member’s health care.
            </p>
            <h4>For Treatment Alternatives:</h4>
            <p>
              Senocare may disclose the member’s health information to recommend
              possible treatment options or alternatives that may be of interest
              to the member.
            </p>
            <h4>In case of a risk to Public Health:</h4>
            <p>
              Senocare will/may disclose the member’s health information in case
              of an infectious disease, injury or disability or in case of a
              medicine/product defect to track or enable product recall,
              replacements.
            </p>
            <h4>Incase of Domestic Violence, Abuse, and Neglect:</h4>
            <p>
              Seno care will/may disclose the member’s health information to the
              local authorities in case of any negligence, abuse or domestic
              violence observed or reported by the member as a victim/ observer,
              only if the member wishes and expresses to Senocare for it to be
              reported.
            </p>
            <h4>Incase of Legal Proceedings:</h4>
            <p>
              Senocare will/may disclose member’s health information in the case
              of any legal proceedings if required by the local authorities or
              for any other lawful purposes. However, the member will be
              notified by Senocare post which Senocare may/will share the health
              information.
            </p>
            <h4>To Medical Examiners:</h4>
            <p>
              Senocare will/may disclose member’s health information to medical
              examiners if required to determine the member’s cause of a fatal
              accident/incident or death.
            </p>
            <h4>To Funeral Homes:</h4>
            <p>
              Senocare will/may disclose member’s health information to funeral
              homes/agencies to organize the funeral arrangements.
            </p>
            <h4>Incase of Organ Donations:</h4>
            <p>
              Senocare will/may disclose member’s health information if the
              member has assigned his/ her organs post the member’s death to be
              donated.
            </p>
            ...
            <p>
              <b>
                Please note that the above list is illustrative in nature and in
                no way exhaustive or limits the authority of Senocare to share/
                disclose health (and other) information of a member as may be
                required for providing the services opted by the member in his/
                her sole discretion and judgment.
              </b>
            </p>
          </Col>
        </Row>
        <Row>
          <Col>
            ...
            <p>
              Senocare members can request for restriction rights pertaining to
              their healthcare information to someone involved in the member’s
              care or in the payment of your care. However, Senocare is not
              obliged to agree with the members request in this situation as
              there can be impulsion to share.
            </p>
            <h3>Right to receive confidential communication:</h3>
            <p>
              Senocare member can reserve the right whether or not to share
              their health information in the presence of their family members.
            </p>
        ...
        <Row>
          <Col>
            ...
            <p>
              Senocare is obliged to maintain the privacy of its member’s health
              care information. Senocare will abide by the terms and conditions
              of this notice which may/will be amended time to time. Senocare
              reserves the right to revise, amend or add new provisions to the
              notice for all health information that it maintains. If the notice
              is amended, the copy of the notice will be shared with the member.
              In case the member feels the member’s rights have been violated,
              the member can express complaints to the Senocare Care Manager or
              management directly. Services included in various packages are
              strictly on non-transferable basis by the member. In case the
              member has not been able to use a service during the time frame
              defined, the same cannot be transferred for later use.
            </p>
            <h3>SAFETY & HOMECARE</h3>
            <p>
              Senocare has collaborated with Urban Company/ Urban Clap (UC) for
              various home care services like, AC repair service, Salon
            ...
            <p>
              ...
              time. In such an event, the terms & conditions of those suppliers
              and/ or service providers will automatically be applicable to the
              member(s) for all their services offered through Senocare.
            </p>
            <h3>TECHNOLOGY & TROUBLESHOOTING</h3>
            <p>
              Technology support refers to usage and navigation of commonly used
              apps and devices. Any hardware support, if required, will be
              payable as per actual costs.
            </p>
            <h3>FORMS & FILING</h3>
            <p>
              Income tax filing includes only personal income tax for
              individuals only. Further, corporate tax is not covered as part of
              our service. Confidentiality would be unconditional commitment of
              empaneled professionals
            </p>
            ...
            <p>
              ...
              service booked. However, no refund shall be payable on the payment
              towards the packages availed
            </p>
          </Col>
        </Row>
        <Row>
          <Col>
            <h3>MEMBERSHIP / SENOCARE SERVICES FEES, TAXES & PAYMENT TERMS</h3>
            <ul>
              <li>
                The package & other Senocare service rates are subject to change
                from time to time based on the service provider / goods rate and
                cost of providing service changes.
              </li>
              <li>
              ...
              <li>
                The membership is activated 48 hours post receiving the payment
                in Senocare Account
              </li>
              <li> No credit is extended for Senocare services.</li>
              <li>
                Services are provided as per the inclusions of the package & any
                additional service requested is at additional cost as would be
                advised by the Senocare managers.
              </li>
              <li>
              ...
              <li>
                Payment for professionals like CA, Lawyers, Travel Agency are as
                per the understanding between the member and such professional
              </li>
              <li> Invoices will be sent by email only</li>
              <li>
                Senocare encourages payment by cheque / bank Transfer / Paytm
                for the services / package being booked and any payment made in
                Cash is done on the member's risk
              </li>
              <li>
                Senocare team is not allowed to receive partial payment against
                the Invoice. Members are requested to make full payment as per
                the Invoice value
              </li>
              <li>
                In case of Cheque dishonor, in addition to remedies available in
                law, Senocare is entitled to collect Rs. 500.00 as a penalty
                over and above the invoice value
              </li>
              <li>
        ...
        <Row>
          <Col>
            ...
            <ul>
              <li>
                The member agrees and acknowledges that the role of Senocare and
                its team is limited to facilitating/ arranging/ managing the
                provision of services requested by the member(s) from time to
                time under the selected package. In this regard, the member
                completely understands and agrees that Senocare shall in no way
                be liable for the acts or omissions of the suppliers/ selected
                service providers (nurses, attendants, CA, lawyers, doctors,
                diagnostic labs, etc.) nor for any dispute connected with or
                arising out of the services provided by such suppliers/ service
                providers in any manner whatsoever.
              </li>
              <li>
                The member recognises that use of Senocare services shall be at
                his/her own risk and that each member shall be solely
                responsible for their own safety and the safety of their
                belongings.
              </li>
              <li>
                The member may note that Senocare has no quality control over
                third-party products & services such as drugs, diagnostics etc.
                and shall not responsible or liable for products or service
                quality deficiency. Further, Senocare does not exercise direct
                control or discretion over suppliers/ service providers such as
                attendant/nursing staff, Urban Clap professionals (plumbers,
                electricians, etc.) while working at member’s home and disclaims
                all responsibilities for such person’s conduct or omissions
                whatsoever.
              </li>
              <li>
                ...
                liability arising from negligence or the actions of the supplier
                and/ or service providers and/ or professionals performing the
                required services for the member upon request.
              </li>
              <li>
                Senocare does not provide medical advice, diagnoses or
                recommendations about medical treatment, and does not recommend
                or endorse any products or information for any circumstances.
                The member expressly acknowledges and agrees that Senocare is
                not responsible for the results of any decisions made by the
              ...
              <li>
                ...
                arising out of or in any way connected with use of the products/
                services of suppliers/service providers/professionals, whether
              ...
              <li>
                ...
                related to provision of services under the selected package.
              </li>
              <li>
                The member also agrees that Senocare shall not be responsible or
                liable to the member, or any party, for the statements or
              ...
              <li>
                ...
                LIABILITY), ARISING FROM PROVIDING SERVICES TO THE MEMBER UNDER
                THE SELECTED PACKAGE, EVEN IF SENOCARE HAS BEEN ADVISED OF THE
                POSSIBILITY OF SUCH DAMAGES. UNDER NO CIRCUMSTANCES SHALL THE
                TOTAL LIABILITY OF SENOCARE FOR ALL DAMAGES, LOSSES OR CAUSES OF
                ACTION EXCEED THE AMOUNT PAID BY THE MEMBER TO SENOCARE, IF ANY.
              </li>
              <li>
                ...
                settlement of a claim or dispute on the advice of legal advisers
                of Senocare) incurred or suffered by Senocare arising out of any
                breach by the member of any provision of these Terms and
                Conditions, or arising out of any claim that the member had
                breached any provision of these Terms and Conditions.
              </li>
            </ul>
            <h3>FORCE MAJEURE</h3>
            <p>
              Senocare shall not be liable for any delay or default in the event
              Senocare is unable to perform any of its obligations towards the
              member(s) as a result of natural disasters, actions or decrees of
              governmental bodies, communication line failures which are not
              caused due to the fault of the affected member, or any other delay
              or failure which arises from causes beyond a party’s reasonable
              control and without negligence or wilful misconduct of the
              Senocare otherwise chargeable with failure, delay or default
              including but not limiting to, strikes, riots, protests, mass
              demonstration, government imposed restrictions, epidemic/
              pandemic, civil commotion, fire, floods, explosions, acts of God,
              acts of State, war, enemy action or terrorist action (hereafter
              referred to as a “Force Majeure Event”). Senocare shall
              immediately give written notice to the member of the facts which
            ...
            <ol type="i">
              <li>
                The member shall have no right to assign its rights under these
                Terms and Conditions;
              </li>
              <li>
                These Terms and Conditions may not be and shall not be deemed or
                construed to have been modified, amended, rescinded or canceled
                in whole or in part, except by written instrument which makes
                specific reference to this MOU and which specifies that these
                Terms and Conditions are being modified, amended, rescinded or
                canceled by Senocare;
              </li>
              <li>
                If any provision of these Terms and Conditions shall be declared
                invalid or illegal for any reason whatsoever, then,
                notwithstanding such invalidity or illegality, the remaining
                terms and provisions of these Terms and Conditions shall remain
                in full force and effect in the same manner as if the invalid or
              ...
              <li>
                ...
                the right or obligation consented to, waived or purported to be
                violated;
              </li>
              <li>
              ...
              <li>
                Any notice, demand or other communication given or made under or
                in connection with the matters contemplated by these Terms and
                Conditions, shall be in writing and delivered, personally, by
                courier, registered airmail or by e-mail to the Parties at the
                addresses of the Parties and shall be deemed delivered when
                received/ refused by the Party or the next business day
        ...
        <Row>
          <Col>
            ...
            <p>
              ...
              booked the Senocare Package after doing due diligence and he / she
              agrees to all the Terms and Conditions attached to this consent
              form.
            </p>
            <p>
              The member(s) and/or the Subscriber (as applicable) hereby agrees
            ...
            <p>
              ...
              by me and/or by my family member is updated, true and accurate. I
              understand that Senocare is a service facilitator and I am in
            ...
            <p>
              ...
              endeavour to assist me with my day to day requirements of utility
              services by sourcing various services for me through their
              reliable collaborators/ associate partners and business
              associates, all of which I am free but under no obligation to use.
              I also understand that the Terms and Conditions of all of
            ...
            <p>
              ...
              personnel/ professional providing services, member(s) information
              (medical and otherwise) to be provided and updated etc., and I
              hereby confirm that I have understood and hereby give my consent
              to the same.
            </p>
            <p>
              ...
              care personnel, etc. may be required. Senocare shall not be liable
              for the views or opinions of such consultants/ professionals and
              the member shall be free to seek an independent opinion from an
              independent consultant of their choice.
            </p>
            <p>
            ...
            <p>
              ...
              explained to me in a language I understand and I fully understand
              the implications of my consent.
            </p>
            <p>
              I, the undersigned, certify that I am over 18 years of age and of
              sound mind, capable to comprehend the nature and scope of this
              consent form (and the attached Terms and Conditions). I am
            ...
            <p>
              I shall further provide necessary documents as may be requested by
              Senocare and/ or its service providers/ professionals from time to
              time pursuant to the subscription availed by me.
            </p>
          </Col>
        </Row>
